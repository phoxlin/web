...
<%
	...
	TaskInfo task=new TaskInfo("sys_task_todo",sId);
...
///////////////////////////////////////////(1).sys_task_todo___sys_task_todo_legend开始///////////////////////////////////////////
	...
	<%
		String sql="select a.*,b.taskname instance_name from sys_task_step a,sys_task_instance b where a.instance_id=b.id and a.state in (?,?,?)";
	
	%>
	
	var sys_task_todo___sys_task_todo_legend_params={
														sql:"<%=sql%>",
														sqlPs:['waitview','viewed','drafted']
													};
